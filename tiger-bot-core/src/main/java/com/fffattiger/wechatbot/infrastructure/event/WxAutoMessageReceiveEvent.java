...
public class WxAutoMessageReceiveEvent extends ApplicationEvent {

    private final WechatMessageSpecification message;

    private final WxAuto wxAuto;

    public WxAutoMessageReceiveEvent(Object source, WechatMessageSpecification message, WxAuto wxAuto) {
        super(source);
